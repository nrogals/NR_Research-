function [ new_vector ] = get_sample_vector(coefficient_mode_matrix, eigenvalues, num_signals, num_eigenvals, time, noise_parameters, flag)
...
new_vector=sum+get_noise_vector(sum, noise_parameters , flag);  

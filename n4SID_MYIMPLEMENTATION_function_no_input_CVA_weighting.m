function [ eigenvalues , eigenvectors] = n4SID_MYIMPLEMENTATION_function_no_input_CVA_weighting( input_data, output_data , j, singular_value_epsilon)

function [ eigenvalues, eigenvectors ] = SSARX_Parabolic_LOSS(input_data, output_data, p, f, minimum_singular_value, fixed_order, probability_outlier_1, probability_outlier_2)
